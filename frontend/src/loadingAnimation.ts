...
function initThreeJs() {
    ...
    // Note: We need a basic material. To pass uniforms, we'd need a ShaderMaterial or onBeforeCompile, 
    // but the user's code just sets material.uniforms = { uTime: { value: 0 } } dynamically.
