export function renderHome(container: HTMLElement) {
  container.innerHTML = `
    <div class="glass-card fade-in" style="text-align: center; padding: 60px 20px;">
      <h1 class="text-title text-gradient">Welcome to Group Maker</h1>
      <p class="text-subtitle" style="margin-bottom: 40px; max-width: 600px; margin-inline: auto;">
        An AI-powered suite for assessing developer skills, discovering project ideas, refining concepts, and judging repositories.
      </p>
