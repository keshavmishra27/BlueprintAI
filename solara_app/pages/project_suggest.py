        ...
        if highlight_text:
            with solara.v.Html(
                ...
                style_=(
                    ...
                    f"background:rgba({accent}, 0.08); border-left:3px solid {accent};"
    ...
    with solara.v.Html(tag="div", style_="max-width:900px; margin:40px auto; padding:0 24px;"):
        ...
        with solara.v.Html(tag="div", style_="margin-bottom:40px;"):
            with solara.v.Html(
                ...
                style_=(
                    ...
                    "padding-bottom:12px; border-bottom:2px solid rgba(0,136,255,0.3);"
                ),
            ):
                solara.v.Html(
                    tag="div",
                ...
                with solara.v.Html(tag="div"):
                    solara.Text(
                        "Industry Resume Projects",
                        style={"font-size": "22px", "font-weight": "700", "color": "#ffffff", "display": "block"},
                    )
                    solara.Text(
                        "Projects that impress recruiters and demonstrate real engineering skills",
                        style={"font-size": "13px", "color": "rgba(255,255,255,0.6)", "display": "block"},
                    )
            ...
            for i, proj in enumerate(resume_projects):
                ProjectCard(
                    ...
                    highlight_label="💼 Why Great for Resume",
                    highlight_text=proj.get("why_great_for_resume", ""),
                    accent="#0088ff",
                )
        ...
        with solara.v.Html(tag="div", style_="margin-bottom:40px;"):
            with solara.v.Html(
                ...
                style_=(
                    "display:flex; align-items:center; gap:12px; margin-bottom:20px;"
                    "padding-bottom:12px; border-bottom:2px solid rgba(0,255,204,0.3);"
                ),
            ):
                solara.v.Html(
                    tag="div",
                ...
                with solara.v.Html(tag="div"):
                    ...
                    solara.Text(
                        "Creative ideas with wow-factor that judges love to pick as winners",
                        style={"font-size": "13px", "color": "rgba(255,255,255,0.6)", "display": "block"},
                    )
            ...
            for i, proj in enumerate(hackathon_projects):
                ProjectCard(
                    ...
                    description=proj.get("description", ""),
                    tech_stack=proj.get("tech_stack", []),
                    highlight_label="🏆 Why It Wins",
                    highlight_text=proj.get("why_it_wins", ""),
                    accent="#00ffcc",
                )
        ...
        with solara.v.Html(tag="div", style_="margin-top:16px;"):
            solara.Button(
                ...
                on_click=reset,
                style=(
                    "width:100%; padding:14px; font-weight:700;"
                    "letter-spacing:0.5px; border-radius:8px;"
                    "background:linear-gradient(90deg, #0088ff, #00ffcc);"
                    "border:none; color:#000;"
                ),
